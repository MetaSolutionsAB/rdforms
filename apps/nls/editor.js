define({
    root: {
        ...
        no_instances: "No instances detected!",
        too_many_instances: "To many instances detected!",
        editorTab: "Editor",
        presenterTab: "Presenter",
        rdfTab: "RDF data",
        initDialogHeader: "Decide which RDF to edit",
        resourceURIHeader: "Provide a URI",
        resourceURIPlaceholder: "If provided the RDF below will be ignored",
        rdfInitHeader: "Or, provide an existing expression in RDF",
