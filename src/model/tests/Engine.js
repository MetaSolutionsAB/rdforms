...
var setup = function () {
  ...
  this.template = this.itemStore.createTemplate(
...
doh.register('Engine matching test', [
  {
    ...
    setUp: setup,
    runTest: function () {
      var binding = rdforms.model.match(
        this.graph,
  ...
  },
  {
    ...
    runTest: function () {
      ...
      doh.t(
        binding.getItemGroupedChildBindings()[1][0].getValue() ===
          "Anna's Homepage"
      );
      doh.t(binding.getItemGroupedChildBindings()[1][0].getLanguage() === 'en');
      doh.t(
        binding.getItemGroupedChildBindings()[1][1].getValue() ===
          'Anna hemsida'
      );
      doh.t(binding.getItemGroupedChildBindings()[1][1].getLanguage() === 'sv');
      doh.t(
        binding.getItemGroupedChildBindings()[3][0].getValue() ===
  ...
  },
  {
    ...
    runTest: function () {
      ...
      doh.t(
        binding
          .getItemGroupedChildBindings()[0][0]
          .getItemGroupedChildBindings()[0][1]
          .getValue() === 'Annie'
      );
      doh.t(
        binding
    ...
    runTest: function () {
      ...
      doh.t(
        binding
          ...
          .getPredicateBinding()
          .getValue() === 'http://purl.org/dc/terms/creator'
      );
      doh.t(
        binding
          .getItemGroupedChildBindings()[4][0]
...
var setup2 = function () {
  ...
  this.root = new rdforms.model.GroupBinding({
    item: this.template.getRoot(),
...
doh.register('Engine create test', [
  {
    ...
    setUp: setup2,
    runTest: function () {
      var titleBinding = rdforms.model.create(
        this.root,
        this.template.getRoot().getChildren()[1]
      );
  ...
  },
  {
    ...
    setUp: setup2,
    runTest: function () {
      var groupBinding = rdforms.model.create(
        this.root,
        this.template.getRoot().getChildren()[0]
      );
      doh.t(groupBinding.getParent() === this.root);
      doh.t(groupBinding.isValid() === false);
      doh.t(this.graph.find().length === 0);
      var valueBinding = rdforms.model.create(
        groupBinding,
        this.template.getRoot().getChildren()[0].getChildren()[0]
      );
      doh.t(groupBinding.isValid() === false);
  ...
  },
  {
    ...
    setUp: setup2,
    runTest: function () {
      var pGroupBinding = rdforms.model.create(
        this.root,
        this.template.getRoot().getChildren()[4]
      );
