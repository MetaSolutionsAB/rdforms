...
define(["dojo/_base/declare",
    ...
    "dijit/form/CheckBox", //For template
    "dijit/layout/BorderContainer", //For template
    "dijit/layout/ContentPane", //For template
    "dijit/tree/dndSource",
    "./ChoicesTreeModel",
    "dojo/text!./ChoicesEditorTemplate.html"
], function(declare, lang, aspect, on, domClass, construct, attr, style, registry, _LayoutWidget, _TemplatedMixin, _WidgetsInTemplateMixin, Tree,
            Menu, MenuItem, TextBox, ValidationTextBox, CheckBox, BorderContainer, ContentPane, TreeDndSource, ChoicesTreeModel, template) {
