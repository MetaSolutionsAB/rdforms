/*global define*/
define(["dojo/_base/declare", "./GroupBinding", "./PropertyChoiceBinding", "./ValueBinding", "./ChoiceBinding", "rforms/template/Group", "rforms/template/Choice"], function(declare, GroupBinding, PropertyChoiceBinding, ValueBinding, ChoiceBinding, Group, Choice) {
