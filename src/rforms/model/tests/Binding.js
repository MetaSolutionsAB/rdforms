...
dojo.provide("rforms.model.tests.Binding");
...
doh.register("Binding-creation", [
  { name: "GroupBinding creation",
	setUp: setup,
	runTest: function() {
		var b1 = new rforms.model.GroupBinding({item: this.t1.getRoot()});
		doh.t(b1 instanceof rforms.model.GroupBinding);
	}
  },
  { name: "ValueBinding creation",
	setUp: setup,
	runTest: function() {
		var b1 = new rforms.model.ValueBinding({item: this.t1.getRoot().getChildren()[1]});
		doh.t(b1 instanceof rforms.model.ValueBinding);
	}
  }
]);
...
var setup2 = function() {
	...
	this.b2 = new rforms.model.ValueBinding({item: this.t1.getRoot().getChildren()[1], statement: this.s2});	
};
...
var setup4 = function() {
	...
	this.t1 = this.is.createTemplate(rforms.template.tests.template1);	
	this.b1 = new rforms.model.GroupBinding({item: this.t1.getRoot()});
	this.b2 = new rforms.model.GroupBinding({item: this.t1.getRoot().getChildren()[0], statement: this.s1, constraints: [this.s2]});
	this.b3 = new rforms.model.ValueBinding({item: this.t1.getRoot().getChildren()[0].getChildren()[0], statement: this.s3});
...
doh.register("Binding-assertions", [
  ...
  { name: "Checking two children validity in hierarchy",
	...
	runTest: function() {
		...
		this.b5 = new rforms.model.ValueBinding({item: this.t1.getRoot().getChildren()[0].getChildren()[1], statement: this.s5});
