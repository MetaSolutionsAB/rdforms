// RDF/JSON fixtures for the model/engine tests.

export const uris = ['http://slashdot.org/', 'http://dn.se/'];

export const predicates = [
  'http://purl.org/dc/terms/title',
  'http://purl.org/dc/terms/maker',
];
...
export const graph2 = {
  'http://example.org/about': {
    ...
    'http://xmlns.com/foaf/0.1/nick': [
      { type: 'literal', value: 'strange, for testing only' },
    ],
    'http://purl.org/dc/terms/related': [
      { value: 'http://example.org/about', type: 'uri' },
    ],
    'http://purl.org/dc/terms/subject': [
      { value: 'http://example.com/instance1', type: 'uri' },
    ],
  },
