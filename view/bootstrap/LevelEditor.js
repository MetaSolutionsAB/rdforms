...
], (declare, lang, event, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, renderingContext,
    Editor, template) => declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
    ...
    //= ==================================================
      ...
      postCreate() {
        ...
        if (!this.externalEditor) {
          this._rdformsDijit = new Editor({ includeLevel: this.includeLevel,
            compact: this.compact }, this._rdformsNode);
          this.show();
        }
      },
